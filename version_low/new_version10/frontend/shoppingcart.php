  ...
  if (!$_SESSION['userid']) {
    ...
    if( isset($_SESSION['check'])){
      if( $_SESSION['check']  == true && isset($_POST['product'])){
        $_SESSION['porduct'][$_SESSION['userid']][] = $_POST['product'];
...
<div class="container text-right">
 <a href="index.php" class="btn btn-warning btn-lg ">Back To Product</a>
</div>
<form action="order.php" method="post">
   <div class="box_view_cart" style="overflow-x:auto;"> <!-- Responsive -->
   <table class="tablecart">
    ...
    <?php 
        ...
        <tr>
            ...
            <td><a href="javascript:void(0)" id="<?php echo $key2; ?>" class="btn btn-danger btn_delete_session">X</a><input type="hidden" value="<?php echo $key; ?>" id="set_user_id"></td>
        </tr>
    <?php
    $no++;
                  }
