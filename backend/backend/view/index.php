         ...
         <div class="col-10">
             ...
             <div class="tab-content" id="nav-tabContent">
               ...
               <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
                 ...
                 <div>
                   <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_brand_shoes_modal">Add New</a>
                   <hr class="bg-white">
               ...
               <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">
                 <div>
                   <button class="btn btn-primary btn_selecte_show_brand_shoes" data-bs-toggle="modal" data-bs-target="#add_shoes_modal">Add New</button>
                   <hr class="bg-white"/>
