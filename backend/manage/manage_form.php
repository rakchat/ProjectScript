...
<body>
  ...
  <br>
    ...
    <div class="row justify-content-center m-3">
        ...
        <label for="exampleFormControlFile1">Your image</label><br>
          <img src="../../frontend/login-frontend/photos/<?php echo $image ?>" style="width:100px;height:100"><br>
  ...
  <center>
        ...
        <a href="../view/index.php"><button type="button" class="btn btn-danger">Back</button></a> 
</center>
