  ...
  <!-- <div class="menu-bar">
    ...
    <div class="container">
      <div class="row">
        ...
        ?>
        <div class="col-md-1 btn2 shadow-lg p-3 mb-3 bg-white rounded btn_seach_form_brand" id="<?php echo $item['brand_id']; ?>"><img src="../backend/resource/uploads/<?php echo $item['logo']; ?>" class="w-100" style="height:50px;"></div>
        <?php } ?>
      </div>
    </div>
    <!--  -->
