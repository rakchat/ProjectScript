<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($user['email'] === $email) { //check email 
            // echo "<script>alert(5555555555555);</script>";
            $_SESSION['error'] = "This E-mail is already registered.";
                header("Location: register-manager.php");
        } else {
...
<head>
    ...
    <link rel="stylesheet" href="css\register_styles2.css" />
</head>
...
<?php 
        if (isset($_POST['back'])) {
            ...
            echo "<script>window.location.href='index-manager.php'</script>";
        }
?>