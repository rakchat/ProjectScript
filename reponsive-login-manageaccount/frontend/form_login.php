...
<body>
    ...
    <div class="loginall">
            ...
            <?php endif; ?>
                ...
                <div class="row justify-content-center">
                    <div class="col m-3">
                        ...
                        <center><button type ="submit" id="submit" naem="submit" class="btn btn-success">Login</button></center>
                    </div>
                </div>
            </form>
        </div>
        ...
        <form method="post">
            <div class="row justify-content-center">
                        <div class="col">
                            <center><button type ="submit" id="register" name="register" class="btn btn-primary">Register</button></center>
                        </div>
                </div>
        </div>
