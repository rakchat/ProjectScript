 ...
 <html>
   ...
   <body class="bg-dark">
     ...
     <div class="" style="padding-left: 25px;">
        <p class="text-white">Manager: <?php echo $_SESSION['user']; ?>
         ...
         <div class="col-10">
             ...
             <div class="tab-content" id="nav-tabContent">
               ...
               <div class="tab-pane fade" id="list-customers" role="tabpanel" aria-labelledby="list-customers-list">
                 ...
                 <div>
                  <a href="register-manager.php" class="btn btn-primary">เพิ่มผู้ใช้งาน</a>
                  <a href="../manage/manage_form_manager.php" class="btn btn-warning">จัดการข้อมูลส่วนตัว</a> <!-- ยังไม่ได้ทำ  -->
                  <div class="container-fluid p-0 m-0">
                    <form action="../config/order.php" method="POST">
                      <div class="row mt-3">
                        <div class="col-md-2">
