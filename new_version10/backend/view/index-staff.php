 ...
 <html>
   ...
   <body class="bg-dark">
     ...
     <div class="" style="padding-left: 25px;">
        <p class="text-white">Staff: <?php echo $_SESSION['user']; ?>
       ...
       <div class="row">
         ...
         <div class="col-2">
           <div class="list-group" id="list-tab" role="tablist" >
             ...
             <a class="list-group-item list-group-item-action" id="list-customers-list" data-bs-toggle="list" href="#list-customers" role="tab" aria-controls="customers">จัดการข้อมูลส่วนตัว</a>
     ...
     <script>
        ...
        $(document).ready(function(){
          ...
          $('#list-customers-list').click(function(){
            window.location.href='../manage/manage_form_staff.php';
          });
