...
<html lang="en">
  ...
  <!-- <div class="menu-bar">
    ...
    <div class="d-flex justify-content-center mt-5 mb-2">
     ...
     <!-- ค้นหาด้วยโลโก -->
    <div class="container logolayout">
      <div class="row">
        <?php 
         $queryBrand=$db->selectAll($con,'brand_shoes');
         foreach($queryBrand as $item){
        ?>
        <div class="col-md-1 btn2 shadow-lg p-3 mb-1 bg-white rounded btn_seach_form_brand" id="<?php echo $item['brand_id']; ?>"><img src="../backend/resource/uploads/<?php echo $item['logo']; ?>" class="w-100" style="height:50px;"></div>
        <?php } ?>
      </div>
    </div>
    <!--  -->
            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <form action="detailorder.php" method="GET">
                 ...
                 <center><p><button type="submit">MORE</button></p></center>
               </form>
              </div>
            </div>
          </div>
